...
export class AddShorebaseServiceTypeStandardizeDatetimeVariable1764572345907 implements MigrationInterface {
    name = 'AddShorebaseServiceTypeStandardizeDatetimeVariable1764572345907'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`plan_activity_mh\` (\`id\` int NOT NULL AUTO_INCREMENT, \`planStartDate\` date NULL, \`planProductQty\` int NULL, \`planActivityId\` int NULL, \`planProductId\` int NULL, UNIQUE INDEX \`REL_21a1f2a7b67f54aca004ec57b1\` (\`planActivityId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`actual_activity_jetty\` (\`id\` int NOT NULL AUTO_INCREMENT, \`actualStartDatetime\` datetime NULL, \`actualEndedAt\` datetime NULL, \`actualJenisLayanan\` varchar(255) NULL, \`actualActivityId\` int NULL, \`shipId\` int NULL, UNIQUE INDEX \`REL_72f00e93a254ef078222910181\` (\`actualActivityId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`plan_activity_jetty\` (\`id\` int NOT NULL AUTO_INCREMENT, \`planStartedAt\` datetime NULL, \`planJenisLayanan\` varchar(255) NULL, \`planActivityId\` int NULL, \`shipId\` int NULL, UNIQUE INDEX \`REL_a1a9253e8beb0477b65bc11f82\` (\`planActivityId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`plan_activity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`remark\` varchar(1023) NULL, \`description\` varchar(255) NOT NULL, \`code\` varchar(255) NULL, \`timesheetTypeCode\` varchar(255) NULL, \`contractServiceId\` int NULL, \`subContractorId\` int NULL, \`companyId\` int NULL, \`shorebaseServiceId\` int NULL, \`uomCode\` varchar(255) NULL, \`statusCode\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`shorebase_service_type\` (\`code\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, PRIMARY KEY (\`code\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`shorebase_service\` ADD \`ssTypeCode\` varchar(255) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`plan_activity\` ADD CONSTRAINT \`FK_85385dda72adc6de6acee051f7a\` FOREIGN KEY (\`statusCode\`) REFERENCES \`activity_status\`(\`code\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`shorebase_service\` ADD CONSTRAINT \`FK_43ae7d9098ba5d91b5cff0368de\` FOREIGN KEY (\`ssTypeCode\`) REFERENCES \`shorebase_service_type\`(\`code\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`shorebase_service\` DROP FOREIGN KEY \`FK_43ae7d9098ba5d91b5cff0368de\``);
        ...
        await queryRunner.query(`ALTER TABLE \`plan_activity\` DROP FOREIGN KEY \`FK_85385dda72adc6de6acee051f7a\``);
        ...
        await queryRunner.query(`ALTER TABLE \`shorebase_service\` DROP COLUMN \`ssTypeCode\``);
        ...
        await queryRunner.query(`DROP TABLE \`shorebase_service_type\``);
