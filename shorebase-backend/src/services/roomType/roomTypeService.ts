...
class RoomTypeET extends ETServer<RoomType> implements ESServer<RoomType> {
    constructor(){
        super(RoomType);
    }    

    toValueLabel(item: RoomType): ESOption {
...
const roomTypeET = new RoomTypeET();

export default roomTypeET;