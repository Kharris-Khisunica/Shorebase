<template>
  <div class="mb-4">
    <UBreadcrumb :items="[{ label: 'Home', to: '/dashboard' }, { label: 'Approval Flow Perusahaan' }]" />

    <h1 class="mt-2 font-bold text-xl sm:text-3xl">Approval Flow Perusahaan</h1>
  </div>
...
const columns: ETColumn<Company>[] = [
  ...
  },
  {
    ...
    onClick: (company: Company) => navigateTo(`/position/approval/workflow/company/${company.id}`)
  },
  {
    id: "internal",
